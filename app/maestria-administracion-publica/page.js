...
const HABILIDADES = [
  { icon:<ICON_IA/>, titulo:"Diseña políticas públicas", desc:"Diseñar e implementar estrategias y políticas públicas con enfoque en impacto social y generación de valor público." },
  { icon:<ICON_DATA/>, titulo:"Gestiona recursos y presupuestos", desc:"Gestionar recursos, presupuestos y proyectos públicos de manera estratégica y sostenible." },
  { icon:<ICON_VISION/>, titulo:"Lidera la innovación institucional", desc:"Liderar procesos de innovación, transparencia y mejora institucional en organizaciones gubernamentales." },
  { icon:<ICON_GEN/>, titulo:"Construye gobernanza y acuerdos", desc:"Coordinar equipos y actores clave para construir acuerdos y fortalecer la gobernanza institucional." },
];
...
const PLAN = [
  { c:1, materias:["Teoría del Estado","Liderazgo innovador para el desarrollo profesional"] },
  { c:2, materias:["Gobernanza e Instituciones","Tópicos selectos 1"] },
  { c:3, materias:["Finanzas públicas y presupuestación basada en resultados","Tópicos selectos 2"] },
  { c:4, materias:["Análisis y diseño de políticas públicas","Tópicos selectos 3"] },
  { c:5, materias:["Gestión estratégica y creación de valor público","Tópicos selectos 4"] },
  { c:6, materias:["Economía pública","Proyecto aplicado"] },
];
...
const FAQS = [
  ...
  { q:"¿Necesito experiencia previa en el sector público?", a:"No es requisito indispensable. El programa está diseñado para profesionistas que buscan impulsar su carrera en la gestión pública, independientemente de su sector de origen." },
    ...
    <>
      ...
      <section style={{ marginTop:"70px", display:"grid", gridTemplateColumns:"1fr 1fr" }} className="hero-grid">
        ...
        <div className="hero-img-col" style={{ position:"relative", overflow:"hidden", minHeight:"480px" }}>
          <img
            src="https://numjvtzzfjzxquooncvv.supabase.co/storage/v1/object/public/assets/OB.png"
        ...
        <div id="formulario" style={{ background:"#7a2531", display:"flex", flexDirection:"column", justifyContent:"center", padding:"3rem 2.5rem", overflow:"hidden" }}>
          ...
          <h1 style={{ fontFamily:"'Outfit',sans-serif", fontSize:"clamp(1.3rem,2.2vw,2rem)", fontWeight:900, color:"#fff", lineHeight:1.12, letterSpacing:"-0.01em", marginBottom:"0.8rem" }}>
            Lidera la transformación del sector público con la{" "}
            <span style={{ color:"#f59700" }}>Maestría en Administración Pública</span>{" "}
            Online de la UAG
          </h1>

          <p style={{ fontSize:"0.93rem", color:"rgba(255,255,255,0.78)", lineHeight:1.6, marginBottom:"1.4rem" }}>
            Diseña políticas públicas con impacto social, lidera procesos de innovación institucional y fortalece la gobernanza — sin dejar de trabajar.
          </p>
      ...
      <section style={{ padding:"4rem 2rem", background:"#fff", maxWidth:"1100px", margin:"0 auto" }}>
        ...
        <div className="intro-benefit-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"3rem", alignItems:"center", marginBottom:"3rem" }}>
          <div>
            <p style={{ fontFamily:"'Outfit',sans-serif", fontSize:"clamp(1.2rem,2.5vw,1.7rem)", fontWeight:800, color:"#333", lineHeight:1.3, marginBottom:"1rem" }}>
              Diseña estrategias públicas que generen valor social.
            </p>
            <p style={{ fontSize:"0.92rem", color:"#555", lineHeight:1.8, marginBottom:"1rem" }}>
              Aquí no solo estudias administración pública — te formas como líder capaz de diseñar, implementar y evaluar políticas y estrategias públicas que generen valor social, fortalezcan la transparencia institucional y contribuyan al desarrollo sostenible.
            </p>
          </div>
        ...
        <div style={{ paddingTop:"2.5rem", borderTop:"2px solid #f59700" }}>
          <p style={{ fontFamily:"'Outfit',sans-serif", fontSize:"1rem", fontWeight:700, color:"#f59700", marginBottom:"0.3rem" }}>Lidera, Transforma e Impacta</p>
          <h2 style={{ fontSize:"clamp(1.4rem,3vw,2rem)", fontWeight:800, color:"#333", marginBottom:"2rem", lineHeight:1.3 }}>
            Forma parte de la generación que transforma las instituciones públicas en motores de desarrollo social sostenible.
          </h2>

          <p style={{ fontFamily:"'Outfit',sans-serif", fontSize:"1rem", fontWeight:700, color:"#555", fontStyle:"italic", marginBottom:"1.5rem" }}>
            ¿Por qué estudiar la Maestría en Administración Pública Online en la UAG?
          </p>
          ...
          <div className="social-proof-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"3rem", alignItems:"center" }}>
            ...
            <div style={{ background:"#f9f9f9", borderRadius:"16px", padding:"2rem", border:"1px solid #eee", position:"relative" }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:"0.8rem" }}>
                ...
                <div>
                  <p style={{ fontFamily:"'Outfit',sans-serif", fontWeight:700, fontSize:"0.93rem", color:"#333" }}>Carlos R. Mendoza</p>
      ...
      <div className={`sticky-bar ${scrollY>400?"show":""}`}>
        <p style={{ fontFamily:"'Outfit',sans-serif", fontSize:"0.9rem", fontWeight:600, color:"#fff" }}>
          🎓 <strong>Maestría en Administración Pública Online</strong> · <span style={{ color:"#f59700" }}>Beca + Bono disponibles</span>
        </p>
        <a href="#formulario">
